...
for cnt, arr, inter in squares:
    ...
    if ok:
        ...
        # for a, b in arr:
        #     cv.line(tmp, intersections[a], intersections[b], (255, 0, 255), 2, cv.LINE_AA)
        # color = (np.random.randint(0, 255), np.random.randint(0, 255), np.random.randint(0, 255))
        # cv.fillConvexPoly(tmp, np.array([intersections[arr[0][0]], intersections[arr[0][1]],
        #                                  intersections[arr[2][0]], intersections[arr[2][1]]]), color)
...
#         x2 = int(x0 - length * (-b))
#         y2 = int(y0 - length * (a))
#         cv.line(tmp, (x1, y1), (x2, y2), (0, 255, 255), 2, cv.LINE_8)
