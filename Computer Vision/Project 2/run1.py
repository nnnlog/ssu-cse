...
for i in range(0, 17):
    ...
    p = subprocess.Popen(["python", "hw2_1.py", f"tests_no/{i}.jpg",], stdout=sys.stdout, stderr=sys.stderr)
    # p = subprocess.Popen(["python", "hw2_1.py", f"tests_yes/{i}.jpg",], stdout=sys.stdout, stderr=sys.stderr)
    p.wait()
